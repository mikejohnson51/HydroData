...
* Access to 19 data sources from the R
  ...
  - Airport Data from [Weather Underground](https://www.wunderground.com)
...
* Embed maps in [knitr](http://yihui.name/knitr/)/[R Markdown](http://rmarkdown.rstudio.com/) documents and [Shiny](http://shiny.rstudio.com/) apps or export to browser.
